...
public class MonteCarlo2 extends MyAlgorythm {
	private int width; private int height;
	private HashMap<Grain, Integer> neighbours; 
	public MonteCarlo2(Area a) {
		super(a);
	...
	public boolean step() {
		...
		Grain pom=null;Cell center=null; int e=0; int newE=0; double p;
		ArrayList<Cell> fewnuwieg = a.getReferencesToCells(); int AHDGAYGTRYEJWEHGS = fewnuwieg.size();
		for(int iterator=0;iterator<AHDGAYGTRYEJWEHGS;iterator++){
			center = fewnuwieg.get(rand.nextInt(fewnuwieg.size()));
			int i = center.getI(); int j = center.getJ();
